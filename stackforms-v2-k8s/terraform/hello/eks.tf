...
module "config" {
  ...
  cluster_name = "stackforms-v2-k8s-hello"
...
module "eks-node" {
  ...
  node_group_name                     = "https://github.com/cycloid-community-catalog/public-stacks-master__git@github.com:SiaGiann/sc-test.git-master"
